export const en = {
  ...
  // Timeline :
  introTitle: "✈️ From Diapers to Deploys",
  introDescription:
  ...
  timelineHeading: "Plot Twists from My Life’s Source Code",
  ...
  sceneInternshipText: `Flaminem — a software vendor for compliance managers in finance.
Built compliance solutions using React, TypeScript, Sass, and GraphQL.`,
  sceneInternshipDate: "2019",

  sceneSievableTitle: "Sievable — First Job",
  sceneSievableText: `Sievable — a filter-based search engine using machine learning.
Led website development with React, TypeScript, Node.js, and GraphQL.`,
  sceneSievableDate: "2020 – 2022",

  sceneNoticeTitle: "Notice — Front-End Developer",
  sceneNoticeText: `Notice — a no-code CMS for FAQ, blogs, and documentation.
Built a custom editor and optimized SEO with React, TypeScript, and Vue3.`,
  sceneNoticeDate: "2022 – 2024",

  exitHeading: "I'm currently freelancing and wandering the earth 🌍",
  exitLine1:
  ...
  // Contact:
  contactHeading: "Talk to me, human 🤖 or risk being assimilated",
  questionStartText: "Would you like to connect via",
  questionStartPostfix: "1) Social Links or 2) Contact Form?",
  questionEmailText: "To start, could you give us",
  ...
  questionDescriptionPostfix: "how can we help you?",
  socialLinksIntro:
  ...
  summaryError: "⚠ Something went wrong. Please try again later.",
  summaryRestart: "Restart",
  summarySending: "Sending...",
  summarySend: "Send it!",
  initialGreeting: "Hey there, explorer of the web 👋",
  initialInstruction:
    "Let's create something meaningful together — or just drop me a line to say hi!",

  // Footer :
  footerCreditPrefix: "© 2024 Made with 💖 by",
  footerCreditSuffix: ".",
  footerThanks:
  ...
  // CTA :
  finalHeadline1: "😱 OH! YOU CAME THIS FAR !!!",
  finalHeadline2: "Ready to blast off? 🚀",
};
